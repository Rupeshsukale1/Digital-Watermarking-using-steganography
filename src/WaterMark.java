...
public class WaterMark extends JInternalFrame implements ActionListener, KeyListener {
    Embed embed;
    Sender send;
    ...
    JTextField filename,txtMessage;
    ...
    public WaterMark(Image_Watermark stegano) {
        super("Water Marking",
              false, //resizable
              true, //closable
              false, //maximizable
        ...
        setSize(580, 400);
        setLocation(10, 10);
        label[0] = new JLabel("Water Mark Image");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == button[0]) {
        ...
        } else if (ae.getSource() == button[2]||ae.getSource() == steg.toolbutton[6]) {
            String f1 = filename.getText();
            msg = txtMessage.getText();
            if (validInput()) {
                operationStarted();
                ImageWatermarking imgWaterMark=new ImageWatermarking();
              boolean result = imgWaterMark.waterMark(f1, msg);
                operationComplete();
                if (result)
            ...
            label[5].setText(" ");
            button[4].setEnabled(false);
        } else if (ae.getSource() == button[4]||ae.getSource() == steg.toolbutton[8]) {
            if (!steg.win6_live) {
