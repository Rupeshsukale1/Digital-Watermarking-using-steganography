 ...
 */
public class Image_Morphing extends WindowAdapter {
    Image resultImage;
    Image img1;
    Image img2;
    Image imgr;
    ...
    public Image_Morphing(Image i1, double w1, Image i2, double w2) {
        ccnt = 0;
        img1 = i1;
        img2 = i2;
    ...
    public static void main(String [] args) {
        if (args.length < 2) {
            ...
            System.err.println("Usage: java Image_Morphing imagefile1 imagefile2");
            System.err.println("Usage: java Image_Morphing imagefile1 weight1 imagefile2 weight2");
            System.exit(0);
        }
   ...
   if (args.length < 4) {
       ...
       w2 = Double.parseDouble(args[3]);
        ...
        Image_Morphing icom = new Image_Morphing(i1, w1, i2, w2);
    }
}
